...
router.get("/", (req, res) => {
  ...
  if (energy_min !== undefined && energy_min !== "") { baseSql += " AND energy >= ?"; params.push(energy_min); }
  if (energy_max !== undefined && energy_max !== "") { baseSql += " AND energy <= ?"; params.push(energy_max); }
  if (power_min !== undefined && power_min !== "") { baseSql += " AND power >= ?"; params.push(power_min); }
  if (power_max !== undefined && power_max !== "") { baseSql += " AND power <= ?"; params.push(power_max); }
  if (might_min !== undefined && might_min !== "") { baseSql += " AND might >= ?"; params.push(might_min); }
  if (might_max !== undefined && might_max !== "") { baseSql += " AND might <= ?"; params.push(might_max); }
